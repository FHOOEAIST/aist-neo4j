...
public class FloatArrayConverterImpl implements FieldConverter<String, Object> {
    @Override
    public void mapForDb(String name, Object uncastValue, Map<String, Object> map) {
        if (uncastValue == null) {
            return;
        }
        float[] value = (float[]) uncastValue;
    ...
    public Object toJavaValue(Object uncastCurrentValue, Object newValue) {
        float[] currentValue = (float[]) uncastCurrentValue;
