...
public class BooleanArrayConverterImpl implements FieldConverter<String, Object> {
    @Override
    public void mapForDb(String name, Object uncastValue, Map<String, Object> map) {
        if (uncastValue == null) {
            return;
        }
        boolean[] value = (boolean[]) uncastValue;
    ...
    public Object toJavaValue(Object uncastCurrentValue, Object newValue) {
        boolean[] currentValue = (boolean[]) uncastCurrentValue;
