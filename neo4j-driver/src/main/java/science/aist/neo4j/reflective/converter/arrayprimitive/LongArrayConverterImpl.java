...
public class LongArrayConverterImpl implements FieldConverter<String, Object> {
    @Override
    public void mapForDb(String name, Object uncastValue, Map<String, Object> map) {
        if (uncastValue == null) {
            return;
        }
        long[] value = (long[]) uncastValue;
    ...
    public Object toJavaValue(Object uncastCurrentValue, Object newValue) {
        long[] currentValue = (long[]) uncastCurrentValue;
